...
/* ═══════════════════════════════════════════════════
   UBS FRAME — Welcome Screen
   ═══════════════════════════════════════════════════ */

const F = "Frutiger, 'Helvetica Neue', Helvetica, Arial, sans-serif";

interface WelcomeScreenProps {
  onCreateEpic: (categoryId?: string) => void;
  onLoadFromGitLab: () => void;
  categories: Array<{ id: string; label: string; icon: string; secs: string[] }>;
}
...
export function WelcomeScreen({
  ...
  const handleActionClick = (actionId: string) => {
    ...
    // Other actions would trigger their respective workflows
  };
      ...
      >
        ...
        >
          <img
            ...
            alt="UBS"
            style={{
              width: sidebarOpen ? 83 : 40,
              minWidth: sidebarOpen ? 83 : 40,
              height: "auto",
